...
ВАЖНО: Пиши ТОЛЬКО простым текстом. НЕ используй никакое форматирование: ни звёздочки (**), ни подчёркивания (_), ни решётки (#), ни другие markdown-символы. Только чистый текст и эмодзи.
`;
